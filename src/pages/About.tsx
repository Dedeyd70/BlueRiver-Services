        ...
        <div className="max-w-3xl mx-auto">
          <motion.div {...fadeUp} className="space-y-6 text-center">
            ...
            <p className="text-muted-foreground leading-relaxed">
              At BlueRiver Services, we believe that a clean space is more than just tidy surfaces — it's about creating environments where people feel comfortable, productive, and at ease. Founded with a simple vision of delivering reliable, high-quality cleaning services, we've grown into a trusted partner for homeowners and businesses alike.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Our name reflects what we stand for: the steady flow of a blue river — consistent, refreshing, and dependable. We bring that same energy to every space we clean, from family homes to corporate offices. Our team is fully trained, insured, and committed to exceeding expectations on every visit.
            </p>
          </motion.div>
        </div>
      </div>
