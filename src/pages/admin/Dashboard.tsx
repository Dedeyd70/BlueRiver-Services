...
const Dashboard = () => {
  ...
  const stats: Stat[] = [
    ...
    { label: "Quote Requests", value: quotesCount ?? 0, icon: FileQuestion, color: "text-accent", path: "/admin/quotes", gate: canQuotes },
    { label: "Open Quotes", value: pendingQuotes ?? 0, icon: FileQuestion, color: "text-amber-500", path: "/admin/quotes?status=open", gate: canQuotes },
    { label: "Contact Submissions", value: submissions ?? 0, icon: MessageSquare, color: "text-primary", path: "/admin/submissions", gate: canMessages },
    { label: "New Inquiries", value: pendingCount ?? 0, icon: MessageSquare, color: "text-amber-500", path: "/admin/messages", gate: canMessages },
    { label: "Services", value: servicesCount ?? 0, icon: Wrench, color: "text-accent", path: "/admin/services", gate: role === "admin" },
    { label: "Gallery", value: galleryCount ?? 0, icon: Image, color: "text-accent", path: "/admin/gallery", gate: canGallery },
    { label: "Testimonials", value: testimonialsCount ?? 0, icon: Star, color: "text-primary", path: "/admin/testimonials", gate: canTestimonials },
  ];
